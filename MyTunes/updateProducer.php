...
$id = mysqli_real_escape_string($connection,$_POST['producer_id']);
$name = mysqli_real_escape_string($connection,$_POST['producer_name']);
$email = mysqli_real_escape_string($connection,$_POST['email']);
$phone = mysqli_real_escape_string($connection,$_POST['phone']);

$sql = "UPDATE PRODUCER SET producerName='$name', emailAddress='$email', phoneNumber='$phone' WHERE ProducerID = '$id'";
